    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!endApp)
            {
                ...
                try
                {
                    result = calculator.DoOperation(cleanNum1, cleanNum2, oper);
                ...
                Console.Write("Press 'n' and Enter to close the application, or press any other key and Enter to continue: ");
